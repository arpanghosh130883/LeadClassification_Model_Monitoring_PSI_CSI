...
y_test = np.array(pd.read_csv('artifacts/train_val_test_data/y_test.csv'))
...
prod_count = np.histogram(y_test_preds, breakpoints)[0]
...
df['Prod Percent'] = df['Prod Count'] / len(y_test_preds)
